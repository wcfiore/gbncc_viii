...
class freq_bw:
    ...
    def __init__(self,freq,bw,is_Sband=False,color='black'):
...
class freq_bw_rcvr:
    ...
    def __init__(self,freq,bw,rcvr,color='black'):
        self.flo   = freq - bw/2.0
        self.fhi   = freq + bw/2.0
        self.rcvr  = rcvr
        self.color = color
...
res_files2 = ['J0032+6946_residuals.dat','J0214+5222_residuals.dat','J0636+5128_residuals.dat', 'J1434+7257_residuals.dat','J1816+4510_residuals.dat']
names2 = ['PSR J0032+6946','PSR J0214+5222','PSR J0636+5128', 'PSR J1434+7257','PSR J1816+4510']
res_files3 = ['J0141+6303_residuals.dat', 'J0415+6111_residuals.dat', 'J0957-0619_residuals.dat', 'J1239+3239_residuals.dat', 'J1505-2524_residuals.dat', 'J1530-2114_residuals.dat']
names3 = ['PSR J0141+6303', 'PSR J0415+6111', 'PSR J0957$-$0619', 'PSR J1239+3239', 'PSR J1505$-$2524', 'PSR J1530$-$2114']
...
for jj in range(5):
    ...
    if nrows==1:
        ...
        obs = [freq_bw_rcvr(57.15,80.0,rcvr='LWA1',color='black'),freq_bw_rcvr(327.0,90.0,rcvr='puppi_327',color='purple'), \
               freq_bw_rcvr(350.0,100.0,rcvr='guppi',color='r'),freq_bw_rcvr(430.0,20.0,rcvr='puppi_430',color='pink'), \
               freq_bw_rcvr(820.0,200.0,rcvr='guppi',color='b'),freq_bw_rcvr(1380.0,800.0,rcvr='puppi_1380',color='cyan')]
        ...
        for o in obs:
            ...
            ax.errorbar(yr_T[inds],res[inds],yerr=err[inds],fmt='o',mfc=o.color,mec=o.color, \
                        ecolor=o.color,label=o.label,ms=1.5,capsize=1,elinewidth=0.5)
        ...
        leg = top_ax.legend(numpoints=1,edgecolor='black',loc=6,bbox_to_anchor=(0.05,0.5),fontsize='x-small')
        ...
        for ii, (rf,nn,ax) in enumerate(zip(res_files,names,axes.flat)):
            ...
            if jj==1:
                obs = [freq_bw(150.0,50.0,is_Sband=False,color='black'),freq_bw(350.0,100.0,is_Sband=False,color='r'), \
                       freq_bw(820.0,200.0,is_Sband=False,color='b'), freq_bw(1500.0,800.0,is_Sband=False,color='g'), \
                       freq_bw(2000.0,200.0,is_Sband=True,color='cyan')]
            else:
            ...
            for o in obs:
                ...
                ax.errorbar(yr_T[inds],res[inds],yerr=err[inds],fmt='o',mfc=o.color,mec=o.color,ecolor=o.color, \
                            label=o.label,ms=1.5,capsize=1.,elinewidth=0.5)
                # ax_R.errorbar(day,res/p0.value/1.0e6,yerr=err,fmt='o',alpha=0.0) # res in microseconds
                check_tot += np.sum(inds)
        ...
        if jj==1:
            leg = axes.flat[2].legend(numpoints=1,edgecolor='black',loc=4)
            leg.get_frame().set_alpha(1.0)
        elif jj==3:
            leg = top_ax.legend(numpoints=1,edgecolor='black',loc=3)
            leg.get_frame().set_alpha(1.0)
        else:
